module Shopping
  class ShippingsController < BaseController
    ...
    def create
      ...
      shipping_option = ShippingOption.find_by_name(params[:shopping_shipping][:shipping_option_name])
      @shipping = @cart.create_shipping(shipping_option_name: shipping_option.name)
